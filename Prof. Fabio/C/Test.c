...
#define v 999  //Intervalo dos numeros a ser gerados (VI..(1-(V+VI))).
...
int main(){
	...
	printf("Gerando numeros aleatorios...\n");
		...
		for (int i = 0; i < n; ++i) //Grava num vetor os numeros que serao gerados.
		{
	...
	for (int i = 0; i < v; ++i) //Imprime a qtde de cada numero com sua respectiva porcentagem.
